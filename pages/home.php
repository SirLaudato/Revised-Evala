...
<body>
    ...
    <div class="first-content">
        ...
        <div class="bottom-content">
            ...
            <p>Here is your overview of the Evaluations.</p>
            <div class="progress">
                <div class="progress-indicator">Total Evaluations
                    <div class="total-eval">1</div>
                </div>
                <div class="progress-indicator">
                    <div>Total Pending</div>
                    <div class="total-pend"><?php if ($_SESSION['status'] == 'Completed') {
                                            $_SESSION['total'] = 0;
                                            echo $_SESSION['total'];
                                        } else {
                                            $_SESSION['total'] = 1;
                ...
                <div class="progress-indicator">
                    <div class="total-comp"><?php if ($_SESSION['status'] == 'Completed') {
                                            $_SESSION['total'] = 1;
                                            echo $_SESSION['total'];
                                        } else {
                                            $_SESSION['total'] = 0;
