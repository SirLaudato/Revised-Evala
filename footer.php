      			...
      			<div class="footer-links">
        				<div class="footer-links1">
          					...
          					<div class="footer-resources">
            						<div class="links">Catalog</div>
            						<div class="links">Contact Support</div>
            						<div class="links">Account</div>
          					</div>
        				</div>
        				<div class="footer-links1">
          					<div class="footer-name">
            						<div class="navigation">RESOURCES</div>
          					</div>
          					<div class="footer-resources">
            						<div class="links">Research Papers</div>
            						<div class="links">Support Center</div>
            						<div class="links">Contact Us</div>
          					</div>
        				</div>
        				<div class="footer-links3">
          					<div class="footer-name">
            						<div class="navigation">Company</div>
          					</div>
          					<div class="footer-resources">
            						<div class="links6">About the Project</div>
            						<div class="links7">Collaborate with Us</div>
    		...
    		<div class="bottom-footer">
      			...
      			<div class="footer-copyrights">
        				<div class="footer-copyright-texts">
          					<div class="text">©2024 Innovatio. All rights reserved</div>
        				</div>
      			</div>
    		</div>
  	</div>
